/* =========================================================================
   course-content.js — static course content data
   Pulled out of the old app.js verbatim. This is pure data (no DOM, no
   localStorage) so it's safe to import from anywhere: api.js wraps it
   with the localStorage-backed "admin-added course" fallback logic.
========================================================================= */
...
// Generic 5-unit content module used for any admin-added course that
// doesn't have hand-written content yet, so the catalog never breaks.
export function genericUnits(){
    return [
        {
